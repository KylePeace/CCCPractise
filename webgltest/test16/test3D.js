...
function main() {
	...
	var translation = [-150, 0, -360];
  	var rotation = [Funs.degToRad(190), Funs.degToRad(40), Funs.degToRad(320)];
  	var scaleArr = [1, 1, 1];
	var filedOfView =Funs.degToRad(60)
	var ZNear = 1
	var ZFar = 2000
	// Setup a ui.
	...
	webglLessonsUI.setupSlider("#filedOfView", {
		value:Funs.radToDeg(filedOfView),
		slide: updateFiledOfView(),
		min:1,
		max: 200,
	});
	...
	function updateFiledOfView () {
		return function (event, ui) {
			filedOfView =Funs.degToRad ( ui.value);
			drawScene();
		};
	}
	...
	function drawScene() {
		...
		var matrix = m4.perspective(filedOfView,aspect,ZNear,ZFar)
